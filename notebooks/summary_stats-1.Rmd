...
### Factor variables
Let's try to reproduce the first part of table 1 from the paper.  
...
Let's compare this to the original table: 
![First three characteristics from Table 1](images/Table 1a.png)

### Numerical variables

The bottom part of table 1 contains summaries of numerical variable

![Numeric characteristics from Table 1](images/Table 1b.png)
