...
Markdown is a intuitive language which can easily be converted to html. It's a really simple way to style text for websites. It's a good language to write your README files in (as well as commits/pull requests on GitHub - since it will be automatically rendered in all those places on GitHub), or other files to store on GitHub/the OSF and it's also the basis for RMarkdown. Markdown files use a .md extension.
...
RMarkdown files use a .Rmd extension.
