...
* Use the Open Science Framework to timestamp and archive a pre-registration, so you can prove you made a prediction ahead of time.
...
In addition to correcting for HARKing, registered reports also correct for publication bias (positive results are more interesting than negative ones, so they get published more, even though they just as important!)

Extra great for research(ers) because:
* You can publish non-significant results 
* You will be able to benefit from knowing what __doesn't__ work.
...
3. Attempt to fill out your chosen form related to either your current research or an upcoming piece of research.